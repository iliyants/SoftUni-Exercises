...
namespace FastFood.App
{
	public class Startup
	{
		...
		private static void ImportEntities(FastFoodDbContext context, string baseDir = @"D:\Entity Framework Core Exams\C#DBAdvancedExam-10.12.2017\01. Model Definition_Datasets\")
		{
			const string exportDir = @"D:\Entity Framework Core Exams\C#DBAdvancedExam-10.12.2017\01. Model Definition_Project Skeleton\FastFood.App\ImportResults\";
