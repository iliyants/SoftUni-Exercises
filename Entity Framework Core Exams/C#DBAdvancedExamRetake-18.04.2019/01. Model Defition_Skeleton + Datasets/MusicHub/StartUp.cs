namespace MusicHub
{
    ...
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            var importLocation = @"D:\Entity Framework Core Exams\C#DBAdvancedExamRetake-18.04.2019\01. Model Defition_Skeleton + Datasets\MusicHub\ImportResults\";
            var writers = "ImportWriters.json";
            var songs = "ImportSongs.xml";
            var songPerformers = "ImportSongPerformers.xml";
            var producerAlbums = "ImportProducersAlbums.json";
           ...
           // DataProcessor.Deserializer.ImportWriters(context, importLocation + writers);
