...
namespace P01_HospitalDatabase.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientsMedicaments_PatientsMedicaments_PatientMedicamentMedicamentId_PatientMedicamentPatientId",
                        columns: x => new { x.PatientMedicamentMedicamentId, x.PatientMedicamentPatientId },
                        principalTable: "PatientsMedicaments",
                        principalColumns: new[] { "MedicamentId", "PatientId" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientsMedicaments_PatientMedicamentMedicamentId_PatientMedicamentPatientId",
                table: "PatientsMedicaments",
                columns: new[] { "PatientMedicamentMedicamentId", "PatientMedicamentPatientId" });
